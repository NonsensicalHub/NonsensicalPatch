...
namespace NonsensicalPatcher
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            _oldRootPath = ConfigurationManager.AppSettings["OldRootPath"];
            OldRootPathBox.Text = _oldRootPath;
            _newRootPath = ConfigurationManager.AppSettings["NewRootPath"];
            NewRootPathBox.Text = _newRootPath;
            _patchPath = ConfigurationManager.AppSettings["PatchPath"];
            ExportPathBox.Text = _patchPath;
            _patchTargetRootPath = ConfigurationManager.AppSettings["PatchTargetRootPath"];
        ...
        {
            MessageTextBox.Dispatcher.Invoke(DoAppendMessage, new object[] { newMessage });
        }
